...
TableGen [DRR](../mlir-tablegen/drr): a small, purpose-built language with its
...
> [`../mlir-lsp/`](../mlir-lsp/README.md) track shows how to run it and wire
> it into an editor.
>
> Every lesson here mirrors one in [`../mlir-tablegen/drr/`](../mlir-tablegen/drr):
> same toy dialect, same rewrites, the other language. Read them side by side.
> The [capstone](../mlir-tablegen/capstone-toy) then runs a DRR pattern and a
...
The [capstone](../mlir-tablegen/capstone-toy/README.md) runs
[`ToyPatterns.pdll`](../mlir-tablegen/capstone-toy/include/Toy/ToyPatterns.pdll)
...
- The DRR lessons these mirror — [`../mlir-tablegen/drr/`](../mlir-tablegen/drr/README.md)
