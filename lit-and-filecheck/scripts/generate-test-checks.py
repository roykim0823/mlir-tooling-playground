#!/usr/bin/env python3
# Vendored copy of mlir/utils/generate-test-checks.py from the LLVM project,
# tag llvmorg-20.1.8, for the lit-and-filecheck tutorial (Tutorial 6). The file
# is unmodified apart from this note. Upstream:
#   https://github.com/llvm/llvm-project/blob/llvmorg-20.1.8/mlir/utils/generate-test-checks.py
# License: Apache-2.0 WITH LLVM-exception (see the header below).
