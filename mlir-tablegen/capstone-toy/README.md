...
This ties the [ODS](../ods), [DRR](../drr), [PDLL](../../mlir-pdll),
[passes](../passes), and [interfaces](../interfaces) lessons together into a
...
[`mlir-cmake/`](../../mlir-cmake/README.md) chapter explains every helper this
...
`ToyPatterns.pdll` puts the [`mlir-pdll/`](../../mlir-pdll/README.md)
lessons to work:
...
`ToyInterfaces.td` puts the [`../interfaces/`](../interfaces/README.md)
lessons to work:
...
[`../passes/`](../passes/README.md) lessons for the generated code):
...
[`../../mlir-debugging/`](../../mlir-debugging/README.md) applies to `toy-opt`
unchanged. Try it:
...
covered in the [`mlir-reduce/`](../../mlir-reduce/README.md) track, Section 5.
...
JSON-RPC session run through lit. The [`mlir-lsp/`](../../mlir-lsp/README.md)
...
```bash
./build/toy-lsp-server --lit-test < ../../mlir-lsp/sessions/toy.session 2>/dev/null | ../../mlir-lsp/summarize.py
```
...
helper copies its output under it). The [`../docs/`](../docs/README.md) track
...
The [`mlir-translate/`](../../mlir-translate/README.md) track walks through
