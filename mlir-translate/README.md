...
[`lib/ToyTranslate.cpp`](../mlir-tablegen/capstone-toy/lib/ToyTranslate.cpp):
...
[`tools/toy-translate.cpp`](../mlir-tablegen/capstone-toy/tools/toy-translate.cpp)
is the whole tool:
...
```bash
TOY=../../mlir-tablegen/capstone-toy
