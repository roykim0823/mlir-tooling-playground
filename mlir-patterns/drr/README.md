...
> ops defined in [`../ods/`](../../mlir-tablegen/ods), so each lesson here defines a small `toy`
...
[`../pdll/`](../pdll/README.md), which ends with a DRR-vs-PDLL
comparison.
...
[README](../../mlir-capstone/README.md).
