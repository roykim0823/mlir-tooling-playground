...
you will meet — this repo's [capstone](../../mlir-capstone) and
...
[`tblgen-lsp-server`](../lsp/README.md) reads. Outputs accumulate in
...
[PDLL](../../mlir-patterns/pdll/README.md) and [docs](../../mlir-tablegen/docs/README.md)
tracks.
...
3. Grow it the way the capstone did: attributes/types → add `mlir_tablegen`
   ...
   [`mlir-capstone/CMakeLists.txt`](../../mlir-capstone/CMakeLists.txt).
